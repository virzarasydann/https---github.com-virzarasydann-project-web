    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="cari rumah.php" class="nav-item nav-link active">cari rumah</a>
    ...
    <section class="info">
      ...
      <section class="cards-wrapper">
        ...
        <div class="card-grid-space">
          <div class="num"></div>
          <a class="card">
            <img class="img-fluid1" src="../rumah2.jpg" alt=""> 
            <div class="jarak">
            <table>
              <tr>
                <td><div class="dot"></div></td>
                <td>Harga IDR. 800.000.000 </td>
              </tr>
              <tr>
                <td><div class="dot"></div></td>
                <td>Luas lantai : 8,5 x 40</td>
              </tr>
              <tr>
                <td><div class="dot"></div></td>
                <td>Lebar 1000cm</td>
              ...
              <tr>
                ...
                <td><div class="lihat-selengkapnya"></div></td>
                <td><span>&#8594;</span> Lihat Selengkapnya</td>
              </tr>
            </table>
